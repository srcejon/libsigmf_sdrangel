...
int main() {
    ...
    sigmf::SigMF<sigmf::Global<core::DescrT, multirecordings::DescrT>,
            sigmf::Capture<core::DescrT, multirecordings::DescrT>,
    ...
    auto recording_capture = sigmf::Capture<core::DescrT, multirecordings::DescrT>();
    ...
    recording_capture.get<multirecordings::DescrT>().streams.clear();
    latest_record.captures.emplace_back(recording_capture);
